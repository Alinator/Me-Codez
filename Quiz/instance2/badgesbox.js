 ...
 */
			...
			function badgebox(medal){
				$(document).ready(function(){
					...
					if(medal == "brons"){
						div.innerHTML = "<center> <img src='bronze.png' height='67' width='67'></img><br>CONGRATULATIONS!<br> YOU HAVE EARNED A BRONS BADGE</center><br>";
						amountofbadges++;
						increasebadgesunit();
					}else if(medal == "silver"){
						div.innerHTML = "<center> <img src='silver.png' height='67' width='67'></img><br>CONGRATULATIONS!<br> YOU HAVE EARNED A SILVER BADGE</center><br>";
						...
						div.innerHTML = "<center> <img src='guld.png' height='67' width='67'></img><br>CONGRATULATIONS!<br> YOU HAVE EARNED A GOLD BADGE</center><br>";
						...
						div.innerHTML = "<center> <img src='platinum.png' height='67' width='67'></img><br>CONGRATULATIONS<br> YOU HAVE EARNED A PLATINA BADGE</center><br>";
