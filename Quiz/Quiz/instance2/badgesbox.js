			...
			function badgebox(medal){
				$(document).ready(function(){
					...
					if(medal == "brons"){
						...
						div.innerHTML = "<center> <img src='silver.png' height='67' width='67'></img><br>CONGRATS!<br> YOU HAVE EARNED A SILVER BADGE for answering 15 correct questions</center><br>";
						...
						div.innerHTML = "<center> <img src='guld.png' height='67' width='67'></img><br>CONGRATS!<br> YOU HAVE EARNED A GOLD BADGE for answering 25 questions correct</center><br>";
