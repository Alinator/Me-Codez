...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	...
	<body>
   				<b> Vem/Vilka grundade företaget Microsoft?</b><br>
   				<br>
				<input type=radio name="q1" value="a" onclick="changequiz(),wronganswer('wrong')">a) John W. Thompson<br>
				<input type=radio name="q1" value="b" onclick="changequiz(),increasexp(100)">B) Bill Gates & Paul Allen <br>
				<input type=radio name="q1" value="c" onclick="changequiz(),wronganswer('wrong')">c) Bill Gates & Steve Ballmer<br>
