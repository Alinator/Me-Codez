 ...
 *
 */
public class JMapViewer extends JLayeredPane implements TileLoaderListener {
    ...
    protected void initializeZoomSlider() {
        ...
        zoomSlider.setBounds(12, 360, 35, 150);
        zoomSlider.setOpaque(false);
        zoomSlider.setVisible(true);
        zoomSlider.setBorder(null);
        ...
        int size = 18;
        try {
            ImageIcon icon = new ImageIcon(getClass().getResource("/plus.png"));
        ...
        zoomInButton.setBounds(20, 340, size, size);
        ...
        add(zoomInButton);
        try {
            ImageIcon icon = new ImageIcon(getClass().getResource("/minus.png"));
        ...
        zoomOutButton.setBounds(20, 510, size, size);
    ...
    protected void paintAttribution(Graphics g) {
